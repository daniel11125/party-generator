...
const messageCenter = `<div style="position: absolute; top: 50%; left: 50%; min-width:100px; transform: translate(-50%, -50%); color: white; font-size: 14px; padding: 6px 10px; border-radius: 6px; text-align: center; max-width: 90%; font-family: 'Nanum Myeongjo', 'serif';">"&quot;${messageText}&quot;"</div>`;
